...
{
    public class Sdruzeni : SdruzeniFirma
    {
        public static Dictionary<string, Sdruzeni> seznamSdruzeni = new Dictionary<string, Sdruzeni>();

        //Název 	Balík Krtková Šatánková Kojan - Společná advokátní kancelář

        //Ulice 	Pařížská 28/131
        //Město 	Praha 1
        //PSČ 	11000

        //Kontakty
        //www
        //Email 	balik [zavináč] iol.cz
        //Telefon 	222 313 561
        //Telefon 	224 810 518
        //Mobil
        //Fax 

        public Sdruzeni(XmlNode suroveSdruzeni)
            : base(suroveSdruzeni) { }
        ...
        protected override void NactiPolozkyZeSurovehoXml(XmlNode suroveSdruzeni)
        {
            ...
            if (suroveSdruzeni.ChildNodes.Count == 1)
            {
                // prázdná firma...
                return;
            }
